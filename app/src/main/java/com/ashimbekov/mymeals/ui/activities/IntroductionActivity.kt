package com.ashimbekov.mymeals.ui.activities
...
import com.ashimbekov.mymeals.ui.fragments.intro.FirstIntroductionFragment
    ...
    private fun logIn() {
        ...
        startActivityForResult(
            AuthUI.getInstance()
                ...
                .setLogo(R.drawable.ic_launcher_background) // icon незабыть поставтиь !
                .build(),
            RC_SIGN_IN
        )
    }
    ...
    private fun checkIfUserExists() =
        CoroutineScope(Dispatchers.IO).launch {
            if (introViewModel.ifUserExists()) {
                ...
                withContext(Dispatchers.Main) { pager.setCurrentItem(3, true) }
            }
        }
