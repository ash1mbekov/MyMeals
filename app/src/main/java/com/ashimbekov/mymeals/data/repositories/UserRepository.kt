package com.ashimbekov.mymeals.data.repositories
...
class UserRepository @Inject internal constructor(
    ...
    private val _user: MutableLiveData<User?> =
        liveData(Dispatchers.IO) { emit(getUserPrepared()) } as MutableLiveData<User?>
    ...
    fun deleteAllUsers() = CoroutineScope(Dispatchers.IO).launch {
